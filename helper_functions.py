...
# this code for drawing nyc regions is taken from https://chih-ling-hsu.github.io/2018/05/14/NYC
def draw_region_map(ax, sf, heat={}):
    ...
    # colorbar
    if len(heat) != 0:
        norm = mpl.colors.Normalize(vmin=math.sqrt(min(heat.values())), vmax=math.sqrt(
            max(heat.values())))
